...
abstract class AbstractSourceIT extends NativeTestPicoCliCommand {
    ...
    protected String executeSource(String subCommand) {
        return execute("source " + subCommand + " --platform-address " + apiUrl());
    }

    protected String sourceYaml(String name) {
        return "name: " + name + "\ntype: source\nschema: io.debezium.postgres\nconfig: {}\n";
    }
}
