...
@CommandLine.Command(name = "update", description = "Update an existing source from a YAML file", sortOptions = false)
public class SourceUpdate extends DebeziumCommand {
    ...
    public SourceUpdate(DebeziumJBangMain main) {
        super(main);
    }
